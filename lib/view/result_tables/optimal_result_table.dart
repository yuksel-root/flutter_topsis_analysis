...
class OptimalResultTable extends StatefulWidget {
  const OptimalResultTable({
    Key? key,
  }) : super(key: key);

  @override
  _OptimalResultTableState createState() => _OptimalResultTableState();
}

class _OptimalResultTableState extends State<OptimalResultTable> {
  ...
  void initState() {
    ...
    this.rowData = List.of(Data.OptimalResultRowData);
    this.columnData = List.of(Data.OptimalResultColumnData);
  }
